...
from app.api.v1.endpoints import (
    ...
    tr_consolidation, etp_consolidation, etp_workflow, risk, risco, etp_ai_acceptance
)
...
app.include_router(tr_transform.router, prefix="/api/v1", tags=["TR Transform"])
...
app.include_router(risco.router, prefix="/api/v1/risco", tags=["Risco.AI"])
app.include_router(etp_ai_acceptance.router, prefix="/api/v1/etp", tags=["ETP AI Acceptance"])
