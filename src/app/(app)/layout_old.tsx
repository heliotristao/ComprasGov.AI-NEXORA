...
const navigationItems = [
  ...
  { 
    ...
    items: [
      ...
      { label: "Estudos Técnicos (ETP)", href: "/etp" },
      { label: "Termos de Referência (TR)", href: "/tr" },
    ]
  },
  { label: "Licitações", href: "/licitacoes", icon: "🏛️" },
  { label: "Contratos", href: "/contracts", icon: "📜" },
  {
    label: "Administração",
    items: [
      { label: "Usuários", href: "/admin/users" },
      { label: "Modelos Superiores", href: "/admin/modelos-superiores" },
      { label: "Modelos Institucionais", href: "/admin/modelos-institucionais" },
    ]
  },
]
