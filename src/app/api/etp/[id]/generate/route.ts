...
export async function POST(request: NextRequest, { params }: RouteParams) {
  ...
  const targetUrl = buildPlanningApiUrl(`/etp/${documentId}/generate`)
  ...
  try {
    ...
    console.error(`Erro ao gerar documento do ETP ${documentId}`, error)
    return proxyErrorResponse("Não foi possível gerar o documento final do ETP.")
  }
}
