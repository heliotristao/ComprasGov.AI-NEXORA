...
export async function GET(request: NextRequest, { params }: RouteContext) {
  const targetUrl = buildPlanningApiUrl(`/processes/${params.id}/links`)
  ...
  try {
    ...
    console.error(`Erro ao carregar vínculos do processo ${params.id}`, error)
    return proxyErrorResponse("Não foi possível carregar os vínculos do processo.")
  }
}
