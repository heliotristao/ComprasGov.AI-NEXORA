...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  ...
  const targetUrl = buildPlanningApiUrl(`/tr/${documentId}/autosave`)
  ...
  try {
    ...
    console.error(`Erro ao realizar autosave do TR ${documentId}`, error)
    return proxyErrorResponse("Não foi possível salvar automaticamente as alterações do TR.")
  }
}
