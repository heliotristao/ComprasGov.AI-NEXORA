...
export function AiField({
  ...
  const handleGenerate = React.useCallback(async () => {
    if (!etpId) {
      toast.error("Salve o rascunho do ETP antes de gerar conteúdo com IA.")
      return
    }
    ...
    try {
      ...
      const response = await generateFieldContent(etpId, fieldKey, {
        context,
        currentValue: value,
      })
  ...
  }, [etpId, fieldKey, getContext, value])
